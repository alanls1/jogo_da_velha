        ...
        function cpuJoga(){
            ...
            if(jogando){
                ...
                if(nivel==1){
                    ...
                    //coluna
                    if ( (jogo[0][0]=="O")&&(jogo[1][0]=="X")&&(jogo[2][0]=="") )   
                        {
                        jogo[2][0]="O";
                    ...
                    //coluna3
                    if ( (jogo[0][2]=="X")&&(jogo[1][2]=="O")&&(jogo[2][2]=="") )   
                        {
                        jogo[2][2]="O";
                    }else if ( (jogo[0][2]=="O")&&(jogo[2][2]=="O")&&(jogo[1][22]=="") )   
                        {
                        jogo[1][2]="O";
                    }
                    ...
                    if ( (jogo[0][2]=="X")&&(jogo[1][2]=="X")&&(jogo[2][2]=="") )   
                        {
                        jogo[2][2]="O";
                    }else if ( (jogo[0][2]=="X")&&(jogo[2][2]=="X")&&(jogo[1][22]=="") )   
                        {
                        jogo[1][2]="O";
                    }
        ...
        function inicia(){
            ...
            if(quemComeca==1){
                quemComeca=0;
                quemJoga=quemComeca;
                document.getElementById('dvQuemComeca').innerHTML="quem comeca: jogador";
            }else{
                quemComeca=1;
                quemJoga=quemComeca;
                document.getElementById('dvQuemComeca').innerHTML="quem comeca: cpu";
                cpuJoga();
            }
        };
